          ...
          <form action="{{URL::to('/checklogin')}}" method="post">
            ...
            <div class="content__login--form">
              ...
              <div class="form-group">
                <input type="text" name="username" class="form-control input__login" id="username" placeholder=" ">
                 <label for="" class="form__label">Tên đăng nhập</label>
              </div>
              <div class="form-group">
                <input id="password" type="password" name="password" class="form-control input__login" placeholder=" ">
